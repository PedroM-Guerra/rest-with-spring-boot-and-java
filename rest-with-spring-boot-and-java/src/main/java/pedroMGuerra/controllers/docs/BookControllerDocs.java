package pedroMGuerra.controllers.docs;
...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Adds a new Book",
            description = "Adds a new book by passing a JSON, XML or YML representation of the book",
            tags = {"Book"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Updates a Book's information",
            description = "Updates a Book's information by passing a JSON, XML or YML representation of the book",
            tags = {"Book"},
            responses = {
                    @ApiResponse(
                            description = "Success",
